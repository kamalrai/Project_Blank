...
public class Journey_Details extends JFrame{  //Forth
    ...
    public Journey_Details(){
        ...
        String[] items1 =  {"ACHHAM", "BAGLUNG", "BHAKTAPUR", "CHITWAN","KATHMANDU","KHOTANG","LALITPUR","MORANG","SAPTARI","SOLUKHUMBU"};
        JComboBox comboBox = new JComboBox(items1);
        comboBox.setBounds(150, 100, 150, 27);
        add(comboBox);


        String[] items2 =  {"ACHHAM", "BAGLUNG", "BHAKTAPUR", "CHITWAN","KATHMANDU","KHOTANG","LALITPUR","MORANG","SAPTARI","SOLUKHUMBU"};
